...
import (
	...
	"high-freq-quant-go/exchange/binance/binanceapi/common"
	"high-freq-quant-go/exchange/binance/binanceapi/delivery"
...
func (c *Client) NewListUserUniversalTransfer() *ListUserUniversalTransfer {
...
// NewAssetDividendService init the asset dividend list service
func (c *Client) NewAssetFeeService() *GetAssetFeeService {
	return &GetAssetFeeService{c: c}
}
